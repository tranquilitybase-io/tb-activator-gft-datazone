...
#   echo "Getting http://repo.continuum.io/archive/Anaconda3-2020.07-Linux-x86_64.sh"
#   wget http://repo.continuum.io/archive/Anaconda3-2020.07-Linux-x86_64.sh
#   echo "Running Anaconda3-2020.07-Linux-x86_64.sh"
#   ann_path=/opt/anaconda3
#   echo "Anaconda3 path is $ann_path"
#   bash Anaconda3-2020.07-Linux-x86_64.sh -b -p $ann_path
...
# # echo "# Adding anaconda3 path to PATH" >> /etc/enviroment
# # echo "PATH=/opt/anaconda3/bin:$PATH" >> /etc/enviroment

# # echo "# Adding anaconda3 path to PATH" >> /etc/profile
# # echo "PATH=/opt/anaconda3/bin:$PATH" >> /etc/profile

# # sudo sh -c 'echo PATH=/opt/anaconda3/bin:$PATH >> /etc/enviroment'
...
# Set path
sh -c "echo PATH=/opt/anaconda3/bin:$PATH >> /etc/environment"
